...
const Hompage = () => {
  ...
  useEffect(() => {
    handleGetProucts();
  }, [page, limit, gtePrice, ltePrice, sort, brand]);
  ...
  return (
    <React.Fragment>
      ...
      <div className="container__home">
        <section className="fillters">
          <div className="fillters__title">Fillters:</div>
          <div className="fillters__sort">
